...
const mr007 = async ({
  ...
  // https://unhoarded-monopolistic-kimber.ngrok-free.dev/get-cookies?x_api_key=9KWUP2TUOO26TSW6P9A3&domain=https://www.costco.com/
  // https://unhoarded-monopolistic-kimber.ngrok-free.dev/get-datadome-grainger?x_api_key=9KWUP2TUOO26TSW6P9A3
  /*
...
const { data: { cookies_list: cookieList } } = await axios.request<Mr077Response>({
  url,
});
...
const site = new URL('https://www.costco.com/').hostname.split('.')[1] as Site;
