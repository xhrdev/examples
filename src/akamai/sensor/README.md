...
Akamai's classic scoring channel. The score lives in an `_abck` cookie, and it
is raised by running Akamai's obfuscated sensor script and POSTing the
telemetry it produces. Do that convincingly and the cookie flips to accepted;
do it badly and you stay blocked no matter how many times you retry.
