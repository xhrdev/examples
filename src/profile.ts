 ...
 *
 * WHEN YOU BUMP THIS, take the values from the solver's own fixture
 * (`src/sandbox/base/fixtures/profiles/chrome-<v>-macos.ts` in the xhrdev
 * repo) rather than editing version numbers in place. Fields move that a
